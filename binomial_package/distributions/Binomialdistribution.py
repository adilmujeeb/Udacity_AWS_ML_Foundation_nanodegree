...
class Binomial (Distribution):
    ...
    # 1. the probability of getting a positive outcome
    ...
    def __init__(self, prob=.5, size=20):
        self.n = size #store the probability of the distribution in an instance variable p
        self.p = prob #store the size of the distribution in an instance variable n

        Distribution.__init__(self, self.calculate_mean(), self.calculate_stdev())
            
    # write a method calculate_mean() according to the specifications 
